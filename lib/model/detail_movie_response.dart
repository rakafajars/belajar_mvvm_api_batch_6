...
DetailMovieResponse detailMovieResponseFromJson(String str) => DetailMovieResponse.fromJson(json.decode(str));

String detailMovieResponseToJson(DetailMovieResponse data) => json.encode(data.toJson());
...
class DetailMovieResponse {
    ...
    factory DetailMovieResponse.fromJson(Map<String, dynamic> json) => DetailMovieResponse(
        adult: json["adult"],
